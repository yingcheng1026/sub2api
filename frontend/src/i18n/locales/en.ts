export default {
  ...
  nav: {
    ...
    subscriptions: 'Credits Management',
    accounts: 'Accounts',
    proxies: 'Proxies',
  ...
  usage: {
    ...
    compatNativeGPT: 'Native GPT',
    compatLegacyClaudeAlias: 'Legacy Claude alias',
    compatOtherHistorical: 'Other / historical',
  ...
  admin: {
    ...
    riskControl: {
      ...
      abuse: {
        title: 'HFC Abuse Risk Events',
        hint: 'Combines signup fingerprint, IP prefix, moderation, API key, and manual review evidence.',
        loadFailed: 'Failed to load abuse risk events',
        actionSuccess: 'Risk action applied',
        actionFailed: 'Failed to apply risk action',
        search: 'Search user/key/evidence',
        empty: 'No abuse risk events',
        confirmDisableKey: 'Disable API Key #{id}?',
        confirmDisableAllKeys: 'Disable all active API Keys under UID {id}?',
        confirmFreezeUser: 'Freeze UID {id}?',
        filters: {
        ...
        source: {
          signupRisk: 'Signup Risk',
          contentAutoBan: 'Moderation Auto-Ban',
        },
        severity: {
          low: 'Low',
          medium: 'Medium',
        ...
        actions: {
          ...
          resolveNoAction: 'Resolve',
          falsePositive: 'False Positive',
          disableKey: 'Disable Key',
          disableAllKeys: 'Disable All Keys',
    ...
    // Subscriptions
    subscriptions: {
      title: 'Credits and Legacy Entitlements',
      description: 'Add permanent wallet credits and maintain historical entitlements',
      assignSubscription: 'Add Credits',
      ...
      form: {
        ...
        mode: 'Credit Method',
        modePlan: 'Credits Plan',
        modeGroup: 'Specific Group',
        modeWallet: 'Manual Top-up',
        modeHint: 'Plan Tier = top up from a credits plan; Wallet Topup = add the received manual payment to the permanent credits wallet',
        plan: 'Credits Plan',
        days: 'days',
        walletQuota: 'wallet quota',
        walletInitialUSD: 'Topup Amount (USD)',
        walletInitialHint: 'Manual topup amount in USD. It goes into the permanent credits wallet, e.g. 50.00'
      },
      selectUser: 'Select a user',
      selectPlan: 'Select a credits plan',
      selectGroup: 'Select a subscription group',
      planHint: 'Only for-sale credits plans are shown; wallet quota is read from the plan',
      groupHint: 'Only groups with subscription billing type are shown',
      validityHint: 'Number of days the subscription will be valid',
      walletInitialRequired: 'Please enter a wallet initial balance greater than 0',
      ...
      quotaResetSuccess: 'Quota reset successfully',
      failedToResetQuota: 'Failed to reset quota',
      noSubscriptionsYet: 'No credits or legacy entitlements yet',
      assignFirstSubscription: 'Add credits to get the user started.',
      subscriptionAssigned: 'Credits added successfully',
      subscriptionAdjusted: 'Subscription adjusted successfully',
      subscriptionRevoked: 'Subscription revoked successfully',
      failedToLoad: 'Failed to load subscriptions',
      failedToAssign: 'Failed to add credits',
      ...
      pleaseSelectPlan: 'Please select a plan tier',
      pleaseSelectGroup: 'Please select a group',
      failedToLoadPlans: 'Failed to load plan tiers',
      errorWalletAlreadyActive: 'The user has an incompatible wallet subscription. Ask ops to check the wallet data state.',
      errorWalletTopupUnsupported: 'Wallet topup service is unavailable. Ask ops to check WalletTopupService wiring.',
      errorAssignConflict: 'This user already has a subscription with different assignment semantics. Check validity or notes and try again.',
    ...
    redeem: {
      ...
      wallet: 'Wallet Credits',
      selectCreditsPlan: 'Select Credits Plan',
      selectCreditsPlanPlaceholder: 'Choose an available credits plan',
      creditsPlanRequired: 'Please select a credits plan',
      validityDays: 'Validity Days',
  ...
  purchase: {
    ...
    description: 'Choose a credits amount, pay in the Liandong store, then redeem the code in your account. Manual WeChat top-up is also available.',
    openInNewTab: 'Open in new tab',
    notEnabledTitle: 'Feature not enabled',
    notEnabledDesc: 'The credits top-up entry is not enabled. Contact an administrator for a manual top-up.',
    notConfiguredTitle: 'Credits top-up URL not configured',
    notConfiguredDesc:
      'The top-up entry is enabled but the Liandong store URL is not configured. Contact an administrator for a manual top-up.'
  },
  ...
  payment: {
    ...
    noPlans: 'No credits plans available',
    ...
    admin: {
      ...
      subscriptionOrder: 'Credits Top-up',
      paidAt: 'Paid At',
      ...
      planTypeSubscriptionHint: 'Historical data only; cannot be created or put back on sale.',
      ...
      group: 'Group',
      groupId: 'Group ID',
      walletPlan: 'Wallet Plan',
      walletQuotaUsd: 'Wallet Quota (USD)',
      walletQuotaPlaceholder: 'Enter the credited amount',
      walletQuotaHint: 'Credits plans use a permanent wallet: group_id stays empty and covered groups are selected below.',
      ...
      coveredGroupsRequired: 'Credits plans require at least one covered group',
