  ...
  admin: {
    ...
    subscriptions: {
      ...
      form: {
        ...
        modeWallet: 'Wallet Topup',
        modeHint: 'Plan Tier = assign from a configured monthly wallet plan; Specific Group = legacy v3 subscription; Wallet Topup = add balance to the user-level permanent credits wallet',
        plan: 'Plan Tier',
        days: 'days',
