export default {
  ...
  usage: {
    ...
    compatNativeGPT: '原生 GPT',
    compatLegacyClaudeAlias: '旧版 Claude 别名',
    compatOtherHistorical: '其他 / 历史记录',
  ...
  admin: {
    ...
    riskControl: {
      ...
      abuse: {
        title: 'HFC 综合风控事件',
        hint: '汇总注册指纹、IP 段、内容审计、API Key 和人工处置证据。',
        loadFailed: '加载综合风控事件失败',
        actionSuccess: '风控处置已执行',
        actionFailed: '执行风控处置失败',
        search: '搜索用户/Key/证据',
        empty: '暂无综合风控事件',
        confirmDisableKey: '确定要禁用 API Key #{id} 吗？',
        confirmDisableAllKeys: '确定要禁用用户 UID {id} 下所有启用状态 API Key 吗？',
        confirmFreezeUser: '确定要冻结用户 UID {id} 吗？',
        filters: {
          allSources: '全部来源',
          allSeverities: '全部等级',
          allStatuses: '全部状态',
        ...
        actions: {
          markReviewing: '审核中',
          resolveNoAction: '无操作解决',
          falsePositive: '标记误判',
          disableKey: '禁用此 Key',
          disableAllKeys: '禁用全部 Key',
          freezeUser: '冻结账户',
        },
        table: {
          time: '时间',
    ...
    subscriptions: {
      title: '额度与历史权益',
      description: '为用户增加永久额度，并查看或维护历史权益',
      assignSubscription: '增加额度',
      ...
      form: {
        ...
        modeGroup: '指定分组',
        modeWallet: '人工充值',
        modeHint: '额度档位 = 按固定额度入账；人工充值 = 按客服确认的实际转账金额给用户 credits 钱包加余额',
        plan: '额度档位',
        days: '天',
        walletQuota: '钱包额度',
        walletInitialUSD: '充值金额（USD）',
        walletInitialHint: '手动充值金额，单位 USD。会进入永久 credits 钱包，例：50.00'
      },
      selectUser: '选择用户',
      selectPlan: '选择额度档位',
      selectGroup: '选择订阅分组',
      planHint: '仅显示可售的额度档位；钱包额度将从套餐配置读取',
      ...
      noSubscriptionsYet: '暂无额度或历史权益',
      assignFirstSubscription: '为用户增加额度以开始使用。',
      subscriptionAssigned: '额度入账成功',
      subscriptionAdjusted: '订阅调整成功',
      subscriptionRevoked: '订阅撤销成功',
      failedToLoad: '加载订阅列表失败',
      failedToAssign: '额度入账失败',
      failedToAdjust: '调整订阅失败',
      failedToRevoke: '撤销订阅失败',
      adjustWouldExpire: '调整后剩余天数必须大于0',
      adjustOutOfRange: '调整天数必须在 -36500 到 36500 之间',
      pleaseSelectUser: '请选择用户',
      pleaseSelectPlan: '请选择额度档位',
      pleaseSelectGroup: '请选择分组',
      failedToLoadPlans: '加载额度档位失败',
      errorWalletAlreadyActive: '用户已有不兼容的钱包订阅，请联系运维检查钱包数据状态。',
      errorWalletTopupUnsupported: '额度卡叠加服务不可用，请联系运维检查 WalletTopupService 注入。',
      errorAssignConflict: '该用户已有语义不一致的订阅，请检查有效期或备注后重试。',
    ...
    redeem: {
      ...
      selectCreditsPlanPlaceholder: '请选择可售额度档位',
      creditsPlanRequired: '请选择额度档位',
      validityDays: '有效天数',
  ...
  purchase: {
    title: '充值额度',
    description: '下单额度后前往链动小铺付款，获取兑换码并回到个人网页兑换；需要其他金额时联系管理员或客服人工充值。',
    openInNewTab: '新窗口打开',
    notEnabledTitle: '该功能未开启',
    notEnabledDesc: '管理员暂未开启额度充值入口，请联系管理员人工充值。',
    notConfiguredTitle: '额度充值链接未配置',
    notConfiguredDesc: '管理员已开启入口，但尚未配置链动小铺链接，请联系管理员人工充值。'
  },
  ...
  payment: {
    ...
    admin: {
      ...
      planTypeSubscriptionHint: '仅用于查看历史数据，不能新建或重新上架',
      ...
      groupId: '分组 ID',
      walletPlan: '钱包套餐',
      walletQuotaUsd: '钱包额度（USD）',
      walletQuotaPlaceholder: '请输入到账额度',
      walletQuotaHint: '额度档位使用永久钱包，group_id 留空，覆盖分组由下方勾选。',
      walletQuotaRequired: '钱包额度必须大于 0',
      coveredGroups: '覆盖分组',
      coveredGroupsHint: '钱包/多分组套餐购买后可使用的标准分组；专属分组请谨慎，只给手动高客单价用户使用。',
      coveredGroupsRequired: '额度档位至少需要选择一个覆盖分组',
      ...
      plansPageTitle: '额度档位管理',
      plansPageDesc: '管理按额度充值档位配置',
      tabPlanConfig: '套餐配置',
      tabUserSubs: '用户订阅',
      selectGroup: '请选择分组',
      groupRequired: '请选择订阅分组',
