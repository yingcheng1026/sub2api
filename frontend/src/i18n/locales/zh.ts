export default {
  ...
  admin: {
    ...
    subscriptions: {
      ...
      form: {
        ...
        modeGroup: '指定分组',
        modeWallet: '钱包（用户级）',
        modeHint: '套餐档位 = 按配置好的月卡套餐分配；指定分组 = 老 v3 订阅；钱包模式 = 手动填写用户级共享余额',
        plan: '套餐档位',
        days: '天',
        walletQuota: '钱包额度',
        walletInitialUSD: '初始余额（USD）',
        walletInitialHint: '钱包初始余额，单位 USD。例：¥299 套餐对应 1500.00'
      },
      selectUser: '选择用户',
      selectPlan: '选择套餐档位',
      selectGroup: '选择订阅分组',
      ...
      errorWalletAlreadyActive: '该用户已有活跃钱包订阅，请先撤销旧订阅或改用额度充值',
      errorWalletTopupUnsupported: '额度充值服务未配置，请联系管理员',
      errorAssignConflict: '分配参数与已有订阅冲突（有效期或备注不一致），请先撤销旧订阅',
      ...
      errorWalletAlreadyActive: '用户已有钱包订阅。当前版本月卡应新建独立钱包行，请确认后端已包含 wallet-stack 迁移。',
  ...
  payment: {
    ...
    admin: {
      ...
      walletQuotaPlaceholder: '留空则使用单订阅分组模式',
      walletQuotaHint: '填写后该套餐走钱包模式，group_id 留空，覆盖分组由下方勾选。',
