export default {
  ...
  admin: {
    ...
    subscriptions: {
      ...
      form: {
        ...
        modeGroup: '指定分组',
        modeWallet: '人工充值',
        modeHint: '套餐档位 = 按额度套餐充值；钱包充值 = 按微信转账金额手动给用户永久 credits 钱包加余额',
        plan: '额度套餐',
        days: '天',
        walletQuota: '钱包额度',
      ...
      selectPlan: '选择额度套餐',
      selectGroup: '选择订阅分组',
      planHint: '仅显示可售的额度套餐；钱包额度将从套餐配置读取',
      ...
      pleaseSelectPlan: '请选择套餐档位',
      pleaseSelectGroup: '请选择分组',
      failedToLoadPlans: '加载套餐档位失败',
    ...
    redeem: {
      ...
      selectCreditsPlan: '选择额度套餐',
      selectCreditsPlanPlaceholder: '请选择可售额度套餐',
      creditsPlanRequired: '请选择额度套餐',
      validityDays: '有效天数',
  ...
  purchase: {
    title: '充值额度',
    description: '下单额度后前往链动小铺付款，获取兑换码并回到个人网页兑换；也可联系人工微信转账充值。',
    openInNewTab: '新窗口打开',
