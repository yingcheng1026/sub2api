...
export type Platform = 'anthropic' | 'openai' | 'antigravity' | 'gemini' | 'kiro' | 'cursor'
...
const BADGE: Record<Platform, string> = {
  ...
  kiro: 'bg-cyan-500/10 text-cyan-600 border-cyan-500/30 dark:text-cyan-300',
  cursor: 'bg-zinc-500/10 text-zinc-700 border-zinc-500/30 dark:text-zinc-200',
}
...
const BADGE_LIGHT: Record<Platform, string> = {
  ...
  kiro: 'bg-cyan-500/10 text-cyan-600 dark:bg-cyan-500/10 dark:text-cyan-300',
  cursor: 'bg-zinc-500/10 text-zinc-700 dark:bg-zinc-500/10 dark:text-zinc-200',
}
...
const BORDER: Record<Platform, string> = {
  ...
  cursor: 'border-zinc-500/20 dark:border-zinc-500/20',
}
...
const ACCENT_BAR: Record<Platform, string> = {
  ...
  kiro: 'bg-gradient-to-r from-cyan-400 to-cyan-500',
  cursor: 'bg-gradient-to-r from-zinc-500 to-neutral-700',
}
...
const TEXT: Record<Platform, string> = {
  ...
  kiro: 'text-cyan-600 dark:text-cyan-300',
  cursor: 'text-zinc-700 dark:text-zinc-200',
}
...
const ICON: Record<Platform, string> = {
  ...
  kiro: 'text-cyan-500 dark:text-cyan-300',
  cursor: 'text-zinc-600 dark:text-zinc-200',
}
...
const BUTTON: Record<Platform, string> = {
  ...
  kiro: 'bg-cyan-600 text-white hover:bg-cyan-700 active:bg-cyan-800 dark:bg-cyan-600/80 dark:hover:bg-cyan-600',
...
const DISCOUNT: Record<Platform, string> = {
  ...
  cursor: 'bg-zinc-100 text-zinc-700 dark:bg-zinc-800/60 dark:text-zinc-200',
}
...
const GRADIENT: Record<Platform, string> = {
  ...
  kiro: 'from-cyan-500 to-cyan-600',
  cursor: 'from-zinc-600 to-neutral-800',
}
...
function isPlatform(p: string): p is Platform {
  return p === 'anthropic' || p === 'openai' || p === 'antigravity' || p === 'gemini' || p === 'kiro' || p === 'cursor'
}
